...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView userFullname, userWeight,  userEmail, userContact,userDoj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userFullname = (TextView) findViewById(R.id.clientname);
        userEmail = (TextView) findViewById(R.id.clientemail);
        userWeight = (TextView) findViewById(R.id.clientweight);
        userContact = (TextView) findViewById(R.id.clientphone);
        userDoj = (TextView) findViewById(R.id.clientdoj);
        ...
        profileUserRef.addValueEventListener(new ValueEventListener()
        {
...

            {
                if(dataSnapshot.exists())
                {
                    ...
                    String userdoj = dataSnapshot.child("DateofJoining").getValue().toString();
                    ...
                    userDoj.setText(userdoj);
                    userWeight.setText(userweight);


                    final String image = dataSnapshot.child("image").getValue().toString();
                    if(!image.equals("default"))
                    {
                        Picasso.with(ProfileActivity.this).load(image).placeholder(R.drawable.addprofileimage).into(profilePic);
                        Picasso.with(ProfileActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.addprofileimage).into(profilePic, new Callback()
                        {
                            @Override
